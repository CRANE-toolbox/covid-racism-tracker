  ...
  return (
    <Layout.Content>
      ...
      <Row justify="center">
        <Col className={styles.SupportPageColumnContent}>
          <p>
            To those outraged by the increase in racist narratives and hate speech online in the aftermath of the Coronavirus pandemic, there are many ways you can support those
            being affected. There are many ways you can help combat the rise of Xenophobia online. From online bystander intervention training to donating to antiracist
          ...
          <p>
            <strong>+00 6344 9755 85 55</strong>
          </p>
        </Col>
      </Row>
